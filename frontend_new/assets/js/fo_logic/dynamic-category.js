function dynamic_category($limit = 5) {
    $('#dynamic_category').html("");
    ...
    getCategories(0)
        ...
        .then(articles => {
            ...
            $.each(articles, function (index, item) {
                //console.log(item);
                if (item) {
                    categoriesArticle.articles[item.category_id].items.push(item);
                }
            });
            ...
            var html = $.get('/cn/module/dynamic_category.html', function (data) {
                var render = template.compile(data);
                var str = render(obj);

                $('#dynamic_category').html(str);
            });
