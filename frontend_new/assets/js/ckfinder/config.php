...
$config['licenseName'] = 'sports website';
$config['licenseKey']  = 'WBKD-AUFF-938F-9AZN-86GR-5GAM-U6MM';
...
$config['resourceTypes'][] = array(
    'name'              => 'Videos(avi,flv,mov,mp4,mpeg)', // Single quotes not allowed.
    'directory'         => '',
    'maxSize'           => '0',
    'allowedExtensions' => 'avi,flv,mov,mp4,mpeg',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['hideFolders'] = array('.*', 'CVS', '__thumbs','_*','ckfinder');
