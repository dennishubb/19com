...
<footer>
    <div class="footer">
        <div><a href="https://19app.app">下载APP</a></div>
        <div><a href="/feedback.php">意见反馈</a></div>
        <div><a href="https://vm.providesupport.com/17b3rzok1ff0818qnvt5vfp4kp">在线客服</a></div>
        <div><a href="javascript:scrollTo(0,0);">返回顶部</a></div>
    </div>
    ...
    <div class="global_menu_container" id="global_menu_show">
        ...
        <div class="global_menu_group">
            ...
            <div class="global_menu_list complex">
                ...
                <div class="block_content"><a href="/sub_category.php?sub_category=53&category=8"><img src="../img/menu/tennis.png"></a>网球</div>
            ...
            <div class="global_menu_list profile">
                ...
                <div class="block_content"><a href="/exchange.php"><img src="../img/menu/point.png"></a>礼品兑换</div>
                <!--<div class="block_content"><a href="#"><img src="../img/menu/star.png"></a>潮星天堂</div>-->
				 <div class="block_content" id='logout'><a href="#"><img src="../img/menu/sign-out.png"></a>登出</div>
            </div>
        </div>
    </div>
<?php
