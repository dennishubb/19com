...
?>
    <div class="main_container">
        <?php
        $featureData = httpGet(CURL_API_URL . '/service/news.php?action=get_popular_news&media_type=2&limit=5');
            ...
            <session>
                <div class="session_video_block">
                    <div class="main_banner video">
                        ...
                        <video autoplay="true" muted="false" loop="true" id="myVideo" style="width: 100%;">
                            <source src="<?php echo $featureData[0]['video_url']?>" type="video/mp4">
                        </video>-->
                        <video src="<?php echo IMAGE_URL.$featureData[0]['video_url']?>" autoplay playsinline loop muted style="width: 100%;" poster="<?php echo IMAGE_URL . $featureData[0]['thumbnail_big_h5'] ?>"></video>
